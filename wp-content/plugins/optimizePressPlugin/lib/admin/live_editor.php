        ...
        if(preg_match('/'.op_shortcode_regex('op_liveeditor_elements').'/s',$sc,$matches) || $op_popup_present){
            ...
            if($GLOBALS['OP_LIVEEDITOR_DEPTH'] === 1){
                ...
                if ($op_popup_present) {
                    ...
                    $processed = preg_replace('/\[op_popup_content[ d|\]].*?\[\/op_popup_content\]/is', $new_popup_elements, $processed);
                ...
                if ($op_popup_present) {
                    $processed .= '<div class="op-hidden op_popup_element_present"><textarea class="op-le-child-shortcode" xz="ss" name="shortcode[]">'. $sc .'</textarea></div>';
                }
                ...
                $child_html = op_process_asset_content(apply_filters('the_content',$child_data['liveeditorElements'])).'<div class="op-hidden"><textarea class="op-le-child-shortcode" ku="vfr" name="shortcode[]">'.op_attr(shortcode_unautop($matches[0])).'</textarea></div>';
