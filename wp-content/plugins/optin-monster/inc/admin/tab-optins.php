				...
				$('.om-bgcolor-picker').wpColorPicker({
					change: function(e, ui){
					    if ( 'om-<?php echo $this->type; ?>-' + theme_type + '-optin-submit' == $(e.target).attr('data-target') ) {
					        $('#' + $(e.target).attr('data-target')).css({ 'background-color': ui.color.toString() });
						    if ( 'postal-theme' == theme_type || 'target-theme' == theme_type ) {
				...
				echo '<div id="om-optin-design" class="optin-ui">';
                	echo '<form id="om-edit-optin" method="post">';
						...
						echo '<div class="optin-config-box">';
                            ...
                            echo '<label class="description" for="om-global" style="font-weight:400;display:inline;margin-left:5px">'.__('If checked, the optin code will be loaded on all pages of your site and <strong>all other settings below will be ignored.','optin-monster').'</strong></label>';
						echo '</div>';
						echo '<div class="optin-config-box">';
                            ...
                            echo '<label class="description" for="om-exclusive" style="font-weight:400;">'.__('Loads the optin only on the comma-separated list of post ID\'s (e.g. 27,434). <strong>All other settings below will be ignored.','optin-monster').'</strong></label>';
						echo '</div>';
						echo '<div class="optin-config-box">';
                            ...
                            echo '<p><label class="description" for="om-categories-0" style="font-weight:400;">'.__('Loads the optin on posts that are in one of the selected categories. <strong>All other settings below will be ignored.','optin-monster').'</strong></label></p>';
						echo '</div>';
						echo '<div class="optin-config-box">';
